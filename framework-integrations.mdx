...
<CardGroup cols={2}>
  <Card title="LlamaIndex" icon="python" href="/framework-integrations/llamaindex">
    Python tool for LlamaIndex agents
  </Card>
  <Card title="Vercel AI SDK" icon="js" href="/framework-integrations/vercel-ai-sdk">
    TypeScript integration for Vercel AI SDK
  </Card>
  <Card title="Pipedream" icon="webhook" href="/framework-integrations/pipedream">
    No-code workflows and agent builder
  </Card>
  <Card title="Google Antigravity" icon="google" href="/framework-integrations/google-antigravity">
...
[View full LlamaIndex documentation →](/framework-integrations/llamaindex)
...
[View full Vercel AI SDK documentation →](/framework-integrations/vercel-ai-sdk)
...
[View full Pipedream documentation →](/framework-integrations/pipedream)
...
[View full Google Antigravity documentation →](/framework-integrations/google-antigravity)
